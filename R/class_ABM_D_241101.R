...
ABM_D <- R6::R6Class("ABM_D", lock_objects = FALSE, cloneable = TRUE,
                         public = list(
                           log = NULL,
                           initialize = function(fields = list(), methods = list(), log = NULL, field_type = NULL) {
                             # フィールドをオブジェクトにセット
                           ...
                           .remove_field = function(field_name){
                             ...
                             if(field_name %in% self$.active_binding_names()){
                               ...
                               index <- which(names(private$.field_type)==field_name)
                               private$.field_type <- private$.field_type[-index]
                             }
                           },
                           #' @description
                           #' add a set of agents
                           ...
                           .add_stage = function(name, stage, field_type){
                             ...
                             switch(field_type,
                                    "net" = {
                                      ...
                                      private$.field_type <- c(private$.field_type, name = "net")
                                      self[[name]] <- stage
                                    },
                                    "mat" = {
                                      ...
                                      private$.field_type <- c(private$.field_type, name = "mat")
                                      self[[name]] <- stage
                                    },
                                    "euc" = {
                                      ...
                                      private$.field_type <- c(private$.field_type, name = "euc")
                                      self[[name]] <- stage
                                    },
                                    "df" = {
                                      ...
                                      private$.field_type <- c(private$.field_type, name = "df")
                                      self[[name]] <- stage
                                    },
                                    "other" = {
                                      private$.field_type <- c(private$.field_type, name = "other")
                                      self[[name]] <- stage
                                    },
                           ...
                           .add_FUN = function(name, FUN, FUN_type){
                             ...
                             switch(FUN_type,
                                    "global_FUN" = {
                                      private$.field_type <- c(private$.field_type, name = "global_FUN")
                                    },
                                    "select_FUN" = {
                                      private$.field_type <- c(private$.field_type, name = "select_FUN")
                                    },
                                    "stop_FUN" = {
                                      private$.field_type <- c(private$.field_type, name = "stop_FUN")
                                    },
                                    "update_FUN" = {
                                      private$.field_type <- c(private$.field_type, name = "update_FUN")
                                    },
                           ...
                           .add_partial_update_FUN_body = function(name, partial_body){
                             ...
                             private$.field_type <- c(private$.field_type, name = "partial_update_FUN_body")
                             self[[name]] <- body
                           },
                           #' @description
                           ...
                           .field_list = function(){
                             ...
                             if(length(agent_names) > 0){
                               agent_list <- lapply(agent_names, function(agent){
                                 if(length(self[[agent]][[1]]$.value_names())>0){
                           ...
                           .agent_attr = function(agents = NULL, attr = NULL, log = NULL, long_format = FALSE){
                             ...
                             if(is.null(agents)){
                               field <- private$.field_type=="agent"
